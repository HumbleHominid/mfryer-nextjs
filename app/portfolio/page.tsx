...
export default function Page() {
  const portfolioItems = [
    {
      title: "ArcadiaSMP Website",
      link: "https://arcadia.yt",
      description:
    ...
    },
    {
      ...
      link: "https://github.com/HumbleHominid/entity-component-system",
      description:
        "The start of an entity component system game engine written in c++ and vulkan.",
    },
    {
      title: "Pong",
      link: "https://github.com/HumbleHominid/Pong",
      description:
    ...
    {
      title: "Wumpus World",
      link: "https://github.com/HumbleHominid/Wumpus-World",
      description:

		...
		<main className="flex flex-col gap-6 font-normal text-lg">
			...
			<div>
				<Image
					...
					height={459}
					className={clsx(
						"shadow-xl rounded-sm mb-4 sm:mb-2 h-auto w-full sm:w-7/12 md:w-1/2",
			...
			<div>
				<Image
					...
					height={771}
					className={clsx(
						"shadow-xl rounded-sm mb-4 sm:mb-2 h-auto w-full sm:w-7/12 md:w-1/2 lg:w-7/12",
						(++incVal) % 2 === 0 ? "float-right sm:ml-4" : "float-left sm:mr-4"
					)}
				/>
				<p className="sm:text-justify">
			...
			<div>
				<Image
					...
					width={1008}
					height={756}
					className="shadow-xl float-left rounded-sm mb-4 sm:mb-2 sm:mr-4 h-auto w-full sm:w-5/12 md:w-5/12"
				/>
				<Image
					src="/cabin_after.jpg"
					alt="Cabin After"
					width={378}
					height={672}
					className="hidden sm:inline shadow-xl float-right rounded-sm mb-2 ml-4 h-auto w-full sm:w-1/4 md:w-1/4"
				/>
				<p className="sm:text-justify mb-4 sm:m-0">
				...
				<Image
					...
					width={378}
					height={672}
					className="inline sm:hidden shadow-xl float-right rounded-sm h-auto w-full sm:w-7/12 md:w-1/4"
				/>
			</div>
			{/* Closing Paragraph */}
			<p className="sm:text-justify">
				If you made it this far, thanks for reading through all that. There are links to this project&apos;s <Link className="hover:underline hover:underline-offset-4" target="_blank" rel="noopener noreferrer" href={GitHub}>GitHub</Link>, my <Link className="hover:underline hover:underline-offset-4" target="_blank" rel="noopener noreferrer" href={YouTube}>YouTube</Link>, and a download for my <Link className="hover:underline hover:underline-offset-4" target="_blank" rel="noopener noreferrer" href={Resume}>resume</Link> here as well as in the footer.
			</p>
		</main>
	);
}
